...
def main():
    ...
    for i in range(args.num_pretrain_epochs):
        for j in range(args.num_pretrain_steps):
            ...
            print(delta_dist, file=log_dist_files[0])
            print(delta_demand, file=log_demand_files[0])
    ...
    for j in range(args.num_env_steps):
        ...
        #print(delta_dist, file=log_dist_files[0])
        #print(delta_demand, file=log_demand_files[0])
        print(delay, file=log_delay_files[0])
        print(throughput_rate, file=log_throughput_files[0])
        print(loss_rate, file=log_loss_files[0])
        print(globalrwd, file=log_globalrwd_file)
        print(circle_flag, file=log_circle_file)
